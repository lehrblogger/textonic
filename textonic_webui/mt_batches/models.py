...
class InstructionFormAll(ModelForm):
	#submitted_tasks = models.ManyToManyField()#widget=forms.TextInput())
	...
	def __init__(self, *args, **kwargs):
		...
		if instance and instance.id:
			...
			#self.fields['submitted_tasks'].widget = SubmittedTaskWidget
...
class TagForm(ModelForm):
	...
	class SubmittedTaskWidget(forms.Widget):
		def __init__(self, attrs=None):
			super(SubmittedTaskWidget, self).__init__(attrs)
		
		def render(self, name, value, attrs=None):
			return render_to_string("mt_batches/text.html", "testing!!!")
