...
urlpatterns = patterns('',
	...
	url(r'^instructions/(?P<object_id>\d+)/$', 'textonic_webui.mt_batches.views.instruction_info'),#generic.list_detail.object_detail', dict(instruction_dict, template_name='mt_batches/instruction_info.html'), {'form':'instruction_info'}),
